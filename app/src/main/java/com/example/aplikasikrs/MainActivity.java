...
import com.example.aplikasikrs.Network.RetrofitClient;
    ...
    private View.OnClickListener myBtnLoginClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (emailText.getText().toString().contains("@si.ukdw.ac.id")){
                ...
                Toast toast = Toast.makeText(getApplicationContext(),"Email salah atau tidak valid gan",Toast.LENGTH_SHORT);
